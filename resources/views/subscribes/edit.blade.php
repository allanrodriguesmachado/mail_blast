<x-app-layout>
    <div class="flex items-center bg-gray-100 dark:bg-gray-900 min-h-screen transition-colors duration-300">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div
                ...
                <div class="p-8">
                    ...
                    <form action="{{ route('subscribe.update', $subscribe) }}" method="POST" class="space-y-6">
                        @csrf
                        @method('PATCH')
